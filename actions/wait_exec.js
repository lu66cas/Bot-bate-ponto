...
action: function(cache) {
	...
	switch(type) {
		case 0:
			noTimeout(this.callNextAction.bind(this, cache), time);
			break;
		case 1:
			noTimeout(this.callNextAction.bind(this, cache), time * 1000);
			break;
		case 2:
			noTimeout(this.callNextAction.bind(this, cache), time * 1000 * 60);
			break;
		case 3:
			noTimeout(this.callNextAction.bind(this, cache), time * 1000 * 60 * 60);
			break;
		default:
